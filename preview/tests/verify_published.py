...
FILES = ['index.html', 'styles.css', 'app.mjs', 'core.mjs', 'data.mjs', 'icon.svg', 'room-v2.mjs', 'room-v2.css', 'evidence-inspector.mjs', 'evidence-inspector.css', 'feed-v2.mjs', 'feed-v2.css']
results = []
for name in FILES:
